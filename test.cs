...
namespace API
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // string urlStr = "/an-post/RL691083499IE";
            ...
            // string urlstr = null;
            // string requestdata = "{\"tracking_number\": \"RL691083499IE\",\"carrier_code\":\"an-post\",\"destination_code\":\"{destination_code}\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
            // string result = new Tracker().getOrderTracesByJson(requestdata, urlstr, "realtime");

            // 10 Modify courier code
            // string   urlStr =null;
            // string requestData="{\"tracking_number\": \"RL691083499IE\",\"carrier_code\":\"an-post\",\"update_carrier_code\":\"china-ems\"}";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"tracking_number\":\"RL691083499IE\",\"carrier_code\":\"an-post\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
            ...
            // string   urlStr =null;
            // string requestData= "[{\"carrier_code\":\"an-post\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
